...
* nice 低优先级用户态CPU时间，就是进程的nice值被调整被1~19之间时的CPU时间
*  steal 当前系统运行虚拟机的时候，被虚拟机占用的CPU时间

#### CPU使用率
* CPU使用率 = 1 - (空闲时间/总CPU时间)
* 平均CPU使用率 = 1 - (空间时间new - 空闲时间old)/(总cpu时间new - 总空闲时间old)
...
#### 拓展阅读
* http://blog.bruceding.com/420.html 
* 